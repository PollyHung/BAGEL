...
#'
#' @param segdf A dataframe containing segment data. It must include columns
...
#' @examples
#' # Example usage
#' result <- addTelCent(segdf = segments, direction = "AMP", telcent = "TEL", coord = c(100, 200), arm = "1q")
#'
#' @export
